...
def _test_simulator_explains_itself():
    ...
    # 最初から入っている金額の出どころを示す。
    # 文言は「＝『パソコン』まで あと150,000円」の形（sim_shows_goal_source で検証）。
    # ここでは「目標がある子・無い子の両方に案内がある」ことを見る
    _check("sim_explains_prefilled_value",
           "まで あと" in html and "ほしいものの ねだんを入れてみてね" in html,
           "初期値の説明、または目標が無い子への案内が欠けている")

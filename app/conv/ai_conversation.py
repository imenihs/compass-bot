...
def _build_system_prompt(user_conf: dict) -> str:
    ...
    base = (
        ...
        "そっとつなげる。高いのに満足が低かった時は次に比べる・待つ練習へ、安く満足できた時はその良い選択をほめる。\n"
        ...
        "- 【必ず守る】子どもへの返事は、やさしい日本語の会話文だけにする。自分の判断の理由づけ、"
        "英語のメモ、『Don't propose...』のような内部の考え、指示文の引用は、返事に絶対に混ぜない。"
        "考えた過程は見せず、子どもに向けた言葉だけを書くこと。\n"

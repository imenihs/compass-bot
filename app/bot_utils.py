...
def _usage_guide_text(age: int | None = None) -> str:
    """子供向けの使い方案内テキストを年齢に応じて返す。
    age が 7 以下はひらがな中心、8〜9 は混合、10 以上は通常表記。"""
    if age is not None and age <= 7:
        ...
        return (
            ...
            "\n"
            "■ おこづかいの そうだん\n"
            "`@compass-bot 〇〇が かいたい` とおくると、いくらもらえるか おしえてくれるよ\n"
            "\n"
            "■ おさいふ\n"
            "・おかねをしりたい: `ざんだかおしえて`\n"
            "・いまのおかねをほうこく: `ざんだか 1234えん`\n"
            "・さいしょのせってい: `しょきせってい` → つぎに `1234えん`\n"
            "\n"
            "■ おかねのきろく\n"
            "・つかったきろく: `ししゅつきろく` とおくると あんないがでるよ\n"
            "・つかった（ざんだかからひく）: `しゅっきん 500えん おかし`\n"
            "・もらった（りんじしゅうにゅう）: `にゅうきん 3000えん おとしだま`\n"
            "\n"
            "■ ちょきんのもくひょう\n"
            "・もくひょうをきめる: `ちょきんもくひょう ゲームき 30000えん`\n"
            "・どこまでたまったかみる: `もくひょうかくにん`\n"
            "\n"
            "■ ふりかえり・りれき\n"
            "・こんげつのふりかえり: `ふりかえり`\n"
            "・さていのりれき: `さていれきし`\n"
            "・にゅうしゅつきんりれき: `にゅうしゅつきんりれき`"
        )
    if age is not None and age <= 9:
        ...
        return (
            ...
            "\n"
            "■ おこづかい相談\n"
            "`@compass-bot 〇〇を買いたい` などそうだんすると査定するよ\n"
            "\n"
            "■ おさいふ\n"
            "・残高かくにん: `ざんだかおしえて`\n"
            "・残高ほうこく: `残高 1234円`\n"
            ...
            "\n"
            "■ お金のきろく\n"
            "・支出記録（メモのみ）: `支出記録` と送るとあんないが出る\n"
            "・支出（残高から引く）: `支出 500円 お菓子`\n"
            "・入金（りんじ収入）: `入金 3000円 お年玉`\n"
            "\n"
            "■ 貯金目標（最大5件）\n"
